...
import com.example.appfragment.adapters.DashboardPagerAdapter;
        ...
        new TabLayoutMediator(tabLayout, viewPager,
                new TabLayoutMediator.TabConfigurationStrategy() {
                    ...
                    public void onConfigureTab(@NonNull TabLayout.Tab tab, int position) {
                        switch (position){
                            case 0: tab.setText("Suma"); break;
                            case 1: tab.setText("Resta"); break;
                            case 2: tab.setText("Multiplicacion"); break;
                            case 3: tab.setText("División"); break;
                        }
                    }
                }
        ).attach();
